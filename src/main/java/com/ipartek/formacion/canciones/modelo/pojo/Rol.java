...
public class Rol {
	...
	public Rol(int id, String nombre, String artista, String cover) {
		super();
		this.id = id;
		this.nombre = nombre;
	...
	public Rol(int id, String nombre, String artista, String duracion, String cover) throws CancionException {
		super();
		this.id = id;
		this.nombre = nombre;
		this.artista = artista;
	...
	public Rol(String nombre, String artista, String duracion) throws CancionException {
		this();
		this.nombre = nombre;
		this.artista = artista;
		this.setDuracion(duracion);
	...
	public Rol(String nombre, String artista, String duracion, String cover) throws CancionException {
